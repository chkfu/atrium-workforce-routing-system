...
function ExpandedHeader({ list_nav_items = [] }: { list_nav_items: TNavItem[] }): JSX.Element {
  return (
    <header className="sticky top-0 z-50 bg-teal-800 p-0">
            ...
            <ul>
              {Object.values(menu.navigate).map((item) => (
                <Link key={item.name} to={item.url}>
                  <li
                    className="flex px-8 md:py-2 py-4 md:text-md md:justify-start justify-center text-lg text-gray-300 hover:bg-teal-700 rounded cursor-pointer duration-300"
          ...
          <div className="py-2">
            ...
            <ul>
              {has_login ? (
                ...
                <Link to={HREF.LOGIN}>
                  <li
                    className="flex md:justify-start justify-center px-8 py-2 md:text-md text-lg text-gray-300 hover:bg-teal-700 rounded cursor-pointer duration-300"
                    onClick={() => setExpandList(false)}
                  >
                    Login
                  </li>
