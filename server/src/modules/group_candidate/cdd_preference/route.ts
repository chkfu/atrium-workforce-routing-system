...
import { TCddPrefBase, TSchemaBase, TUserBase } from '../../../util/types/schema_types';
...
router
  ...
  .get(
    ...
    cdd_pref_controller.get_record_batch(),
  )
  .post(
    auth_controller.access_control_token(),
    auth_controller.access_restrict_roles(enum_user_role.grade_1_assistant, true),
    cdd_pref_controller.restrict_fields_to_editable(),
    cdd_pref_controller.create_record_batch(),
  )
  .patch(
    auth_controller.access_control_token(),
    cdd_pref_controller.restrict_batch_to_owner(),
    cdd_pref_controller.restrict_fields_to_editable(),
    cdd_pref_controller.update_record_details_batch(),
  )
  .delete(
    auth_controller.access_control_token(),
    cdd_pref_controller.restrict_batch_to_owner(),
    cdd_pref_controller.remove_record_batch(),
  );
...
router
  ...
  .get(
    auth_controller.access_control_token(),
    auth_controller.access_restrict_roles(enum_user_role.grade_1_assistant, true),
    cdd_pref_controller.get_record_column_list(),
  );
...
router
  ...
  .patch(
    ...
    cdd_pref_controller.update_record_active_batch(),
  );
...
router
  ...
  .delete(
    auth_controller.access_control_token(),
    auth_controller.access_restrict_roles(enum_user_role.grade_1_assistant, false),
    cdd_pref_controller.empty_record_all(),
  );
...
router
  ...
  .get(
    auth_controller.access_control_token(),
    auth_controller.access_restrict_roles(enum_user_role.grade_1_assistant, true),
    cdd_pref_controller.get_record_by_id(),
  );
