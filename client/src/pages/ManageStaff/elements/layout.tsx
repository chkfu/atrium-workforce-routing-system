...
export function ControlPanelSection(): JSX.Element {
  return (
    <div className='py-4'>
      <div
        className='flex flex-col gap-4 md:flex-col md:gap-4 lg:flex-row lg:gap-4 lg:justify-between duration-400 transition-all'
      >
        <FormButtonBox />
        <FilterSortBox />
      </div>
  ...
  return (
    <div className='pt-2'>
      ...
      >
        ...
        {selectedStaff.length === 1 ? 'candidate' : 'staff'} selected
      </p>
