...
export function FormCreate() {
  ...
  return (
    <form onSubmit={handleSubmit(recalling)} className="flex flex-col h-96" noValidate>
      <h3 className="text-lg font-semibold text-gray-800 mb-3 shrink-0">Create Staff</h3>
      ...
      <div className="overflow-y-auto flex-1">
        ...
        />
        <FormTextField label="Email" register={register('work_email')} error={errors.work_email} />
        <FormTextField
          label="Work Position"
...
export function FormUpdate() {
  ...
  const dispatch = useDispatch();
  const { selectedStaff, setIsUpdating, setSelectedStaff, setTriggerUpdate } = useStaffContext();
  ...
  return (
    <form onSubmit={handleSubmit(recalling)} className="flex flex-col h-96" noValidate>
      <h3 className="text-lg font-semibold text-gray-800 mb-3 shrink-0">Update Staff</h3>
    ...
    <form className="p-2">
      ...
      <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: 'auto 1fr' }}>
        ...
        <FilterSelectInput
          ...
          onChange={(el) =>
            setFilterDepartment(el.target.value === '' ? null : (el.target.value as any))
          }
          options={[
            { value: '1', label: 'Business Analytics' },
            { value: '2', label: 'Cloud Infrastructure' },
...
export const FormSorting = (): JSX.Element => {
  ...
  const { setSortAsc, setSortTarget, triggerSort, setTriggerSort } = useStaffContext();
  //  display
  return (
    <form
