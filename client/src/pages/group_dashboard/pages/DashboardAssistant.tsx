...
import {
  assistant_card_list_personal,
  assistant_card_list_task_panel,
...
export default function AssistantDashboard(): JSX.Element {
  ...
  //  remarks: declaration
  const card_list_personal = assistant_card_list_personal(staff_id);
  const card_list_task_panel = assistant_card_list_task_panel;
